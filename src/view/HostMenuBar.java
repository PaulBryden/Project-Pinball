...
import controller.HostDisconnectListener;
...
class HostMenuBar extends JMenuBar {

    HostMenuBar(MainWindow mainWindow){
        super();
        ...
        menuItem = new JMenuItem("Stop Hosting", KeyEvent.VK_Q);
        menuItem.addActionListener(new HostDisconnectListener(mainWindow));
        menu.add(menuItem);
